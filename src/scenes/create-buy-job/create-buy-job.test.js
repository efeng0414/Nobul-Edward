...
import CreateBuyJobWrapped from "./container";
import {
  SERVICES_EXACT,
  BATHROOMS,
  BEDROOMS,
...
describe("Create Buy Job", () => {
  ...
  const {
    WrappedComponent: CreateBuyJob
  } = CreateBuyJobWrapped.WrappedComponent.WrappedComponent;
  ...
  const containerJSX = <CreateBuyJob {...containerProps} />;

  const containerStoreJSX = (
    <Provider store={mockStore}>
      <CreateBuyJob {...containerProps} />
    </Provider>
  );
